    ...
    <div class="row">
        <div class="col-12">
            <div class="card my-4">
                ...
                <div class="row">
                    <c:choose>
                        <c:when test="${supplierSearchResponse.totalItems % supplierSearchResponse.maxPageItems != 0}">
                            <c:set var="finalPage"
                                   value="${supplierSearchResponse.totalItems / supplierSearchResponse.maxPageItems + 1}"/>
                        </c:when>
                        <c:otherwise>
                            <c:set var="finalPage"
                                   value="${supplierSearchResponse.totalItems / supplierSearchResponse.maxPageItems}"/>
                        </c:otherwise>
                    </c:choose>
