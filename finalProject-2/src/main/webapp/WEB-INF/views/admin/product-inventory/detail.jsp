            ...
            <div class="row">
                ...
                <div class="col-12 col-xl-4">
                    <div class="card card-plain h-100">
                        <div class="card-body">
                            ...
                            <div class="form-group py-2">
                                <label for="expiration"><strong class="text-dark" style="font-size: 15px;">Thời gian hết hạn</strong></label>
                            ...
                            <br>
                            <div class="form-group py-2">
                                <label for="supplierId"><strong class="text-dark" style="font-size: 15px;">Mã nhà cung cấp</strong>&nbsp</label>
                                <form:input path="supplierId" name="supplierId" id="supplierId" type="number"
                                            class="form-control px-2"
                                            style="border: 1px solid black; font-size: 17px;" readonly="true"/>
                            </div>
                            <div class="form-group py-2">
                                <label for="priceInImport"><strong class="text-dark" style="font-size: 15px;">Giá nhập</strong>&nbsp;(VND)</label>
                            ...
                            <c:if test="${not empty productInventoryEdit.orderId}">
                                <div class="form-group py-2">
                                    <label for="orderId"><strong class="text-success" style="font-size: 15px;">Được sử dụng trong đơn hàng</strong></label>
                ...
                <div class="col-12 col-xl-4">
                    <div class="card card-plain h-100">
                        <div class="card-body">
                            <div class="form-group py-2">
                                <label><strong class="text-dark" style="font-size: 15px;">Tình trạng</strong></label>
                                ...
                                <input name="status" id="status" type="text"
                                       value="${status}"
                                       class="form-control px-2"
                                       style="border: 1px solid black; font-size: 17px;" readonly/>
                            </div>
                    ...
                    <div class="card card-plain h-100">
                        <div class="card-body">
                            <div class="form-group py-1">
                                <label><strong class="text-dark" style="font-size: 15px;">Ảnh đại diện</strong></label>
                                <br>
                                <div class="col-sm-9">
